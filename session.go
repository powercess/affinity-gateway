...
var sessionHeaders = []string{"Session-Id", "Session_id", "Conversation-Id", "Conversation_id", "X-Session-Affinity", "X-Session-Id", "X-Opencode-Session", "Thread-Id", "X-Claude-Code-Session-Id", "X-Hermes-Session-Key", "X-Deepseek-Harness-Session-Id"}
